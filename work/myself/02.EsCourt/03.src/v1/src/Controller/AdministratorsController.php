 ...
 */
class AdministratorsController extends AdministratorsAllowedController
{
    ...
    public function view($id = null)
    {
        $administrator = $this->Administrators->get($id, [
            'contain' => ['MenberTypes', 'Facilities', 'Passwords']
        ]);
    ...
    public function add()
    {
        ...
        $menberTypes = $this->Administrators->MenberTypes->find('list', ['limit' => 200]);
        $this->set(compact('administrator', 'menberTypes'));
        $this->set('_serialize', ['administrator']);
    }
